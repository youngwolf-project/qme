...
int main(int argc, const char* argv[])
{
	const ut_input_and_expectation<> inputs[] = {
		...
		//question expression as a sub data expression
		{"a > 0 ? (b > 0 ? (c > 0 ? 1 : 2) : 3) : 4", 4, 3},
		{"a < 0 ? (b < 0 ? (c < 0 ? 1 : 2) : 3) : 4", 3, 4},
		{"(a > 0 ? (b > 0 ? (c > 0 ? 1 : 2) : 3) : 4) + 100", 104, 103},
		{"100 + (a < 0 ? (b < 0 ? (c < 0 ? 1 : 2) : 3) : 4)", 103, 104},
		{"(a > 0 ? ((b > 0 ? (c > 0 ? 1 : 2) : 3) + 1000) : 4) + 100", 104, 1103},
		{"100 + (a < 0 ? ((b < 0 ? (c < 0 ? 1 : 2) : 3) + 1000) : 4)", 1103, 104},
		{"(a > 0 ? (b > 0 ? (c > 0 ? 1 : 2) : 3) : 4) + (a < 0 ? (b < 0 ? (c < 0 ? 1 : 2) : 3) : 4)", 7, 7},
		{"(a > 0 ? (b > 0 ? (c > 0 ? 1 : 2) : 3) : 4) + 10 + (a < 0 ? (b < 0 ? (c < 0 ? 1 : 2) : 3) : 4) + 100", 117, 117},
